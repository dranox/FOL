...
aunt(Person, NieceNephew) :- parent(Person1,NieceNephew), parent(Person2,Person),parent(Person2,Person1),female(Person), Person1 \= Person.

uncle(Person, NieceNephew) :- parent(Person1,NieceNephew), parent(Person2,Person),parent(Person2,Person1),male(Person), Person1 \= Person.

niece(Person, AuntUncle) :- parent(Person1,Person), parent(Person2,AuntUncle),parent(Person2,Person1),female(Person), Person1 \= AuntUncle.

nephew(Person, AuntUncle) :- parent(Person1,Person), parent(Person2,AuntUncle),parent(Person2,Person1),male(Person), Person1 \= AuntUncle.